...
public class QuanLyPhieuNhap extends javax.swing.JPanel {
        ...
        ActionListener ac = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                switch(e.getActionCommand()){
                    case "Thêm":{
                        new ThemPhieuNhap(nhanvien).setVisible(true);
                        break;
                    }
                    case "Làm mới":{
                        loadTableData();
                    ...
                    case "Xem Chi Tiết":{
                        ...
                        new XemChiTietPhieuNhap(id).setVisible(true);
                        break;
                    }
                }
            }
    ...
    private void initTable() {
       String []header = {"Mã Phiếu Nhập","Mã Nhân Viên","Mã Nhà Cung Cấp","Ngày Nhập"};
    ...
    private void loadTableData(ArrayList<PhieuNhap> data) {
        tableFunc.removeAllTable(table);
        defaults = (DefaultTableModel)table.getModel();
