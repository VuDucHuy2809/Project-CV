                        ...
                        <div class="new-products-grids">
                            <div class="new-products-grid">
                                <div class="new-products-grid-left">
                                    <a href="single.html"><img src="images/213.jpg" alt=" " class="img-responsive" /></a>
                                </div>
                            ...
                            <div class="new-products-grid">
                                ...
                                <div class="new-products-grid-right">
                                    <h4><a href="single.html">INTALIA NO VEST</a></h4>
                                    <div class="rating">
                                        <div class="rating-left">
                                            <img src="images/2.png" alt=" " class="img-responsive"/>
                                        </div>
                            ...
                            <div class="new-products-grid">
                                <div class="new-products-grid-left">
                                    <a href="single.html"><img src="images/dv.jpg" alt=" " class="img-responsive" /></a>
                                </div>
                                <div class="new-products-grid-right">
                                    <h4><a href="single.html">Brand Isses</a></h4>
                                    <div class="rating">
                                        <div class="rating-left">
                                            <img src="images/2.png" alt=" " class="img-responsive"/>
                                        </div>
                    ...
                    <div class="products-right-grid">
                        <div class="products-right-grids animated wow slideInRight" data-wow-delay=".5s">
                            ...
                            <div class="sorting-left">
                                <select id="country1" onchange="change_country(this.value)" class="frm-field required sect">
                                    <option value="null">Accessories</option>
                                    <option value="null">Men</option> 
                                    <option value="null">Woman</option>					
                        ...
                        <div class="products-right-grids-position animated wow slideInRight" data-wow-delay=".5s">
                            ...
                            <div class="products-right-grids-position1">
                                ...
                                <p>No need to change the entire wardrobe, with just a few items and these simple tips, you will still be "cooler" in the eyes of the opposite person.</p>
                            </div>
                        </div>
                    </div>
